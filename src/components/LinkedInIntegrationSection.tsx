    ...
    return (
      <div className="bg-neutral-primary rounded-lg shadow-sm border border-neutral-secondary p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-lg font-semibold text-text-primary font-heading">LinkedIn Integration (Personal)</h3>
            <p className="text-sm text-text-secondary mt-1 font-body">
              Connect your LinkedIn account to post to your personal profile (company page posting coming soon)
            </p>
          </div>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-md">
            <p className="text-sm text-blue-800 font-body">
              Connect your LinkedIn account to enable AI-powered personal post creation and scheduling.
            </p>
          </div>
          <Button
        ...
        <div className="space-y-4">
          <div className="p-4 bg-green-50 border border-green-200 rounded-md">
            <p className="text-sm text-green-800 font-body">
              Your LinkedIn account is connected. You can now create and schedule posts to your personal profile.
            </p>
          </div>
