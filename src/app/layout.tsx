  ...
  return (
    <ClerkProvider>
      <html lang="en" className="h-screen">
        <body className="bg-white h-screen overflow-hidden font-['Inter']">
          {/* Modern Header */}
          ...
          {/* Main Content */}
          <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-white h-[calc(100vh-4rem)] overflow-hidden">
            {children}
          </main>
        </body>
      </html>
